...
Facts - store incoming facts - REST API to CRD fact table
Rules - store rule files - REST API to CRD rule table
Results - store outgoing facts - REST API to RD results table

Persist facts and rules and results to MySQL

Attributes for fact - programid, userid, factname, timestamp, json
Attributes for rule - programid, userid, rulename, timestamp, txt
Attributes for result - programid, userid, rulename, factname, timestamp, json

dorule - Rest API (get) to reason over rules - programid, userid, rulename, factname

HTTP Basic Auth for each REST call

Delete pattern - use POST add /del/ to path with id as input
Create pattern - use POST
Read patterns - various
- use GET
- use GET with id as input
- use GET with programid as input
- use GET with programid, userid as input
- use GET with programid, userid, factname as input
- use GET with programid, userid, rulename, factname as input
- use GET with programid, userid, rulename as input
